...
const baseScenario = (name: ScenarioName, demand: number): ScenarioData => ({
  ...
  inventory: [
    ...
    { id: 'i3', name: 'Packaging Kit', category: 'Packaging', unitCost: 4, usagePerProduct: 1, leadTimeDays: 14, moq: 1000, singleSource: false },
  ],
  logistics: [
    { id: 'l1', lane: 'Shenzhen -> Rotterdam', direction: 'Inbound', mode: 'Sea', costPerShipment: 3200, unitsPerShipment: 2400 },
    { id: 'l2', lane: 'NL Plant -> EU Dist', direction: 'Outbound', mode: 'Road', costPerShipment: 700, unitsPerShipment: 900 },
  ],
  machines: [
  ...
  warehouses: [
    { id: 'w1', location: 'Eindhoven RM Hub', type: 'RM', monthlyCost: 15000, utilizationPct: 0.71 },
    { id: 'w2', location: 'Venlo FG DC', type: 'FG', monthlyCost: 18000, utilizationPct: 0.76 },
  ],
  maintenance: [
